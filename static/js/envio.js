...
function guardarDatosFicha() {
    const datosFicha = {
        ...
        antecedentes: ['Cáncer', 'Diabetes', 'Hipertensión', 'Enfermedades Cardiacas', 'Enfermedades Mentales', 'Alergias'].map(enfermedad => ({
            enfermedad,
            ...
            parentesco: document.querySelector(`input[name="${enfermedad}_parentesco"]`)?.value || 'No hay información',
        ...
        datosPatologicos: ['Traumatismos', 'Cirugías', 'Luxaciones', 'Alergias', 'Toxicomanías', 'Padecimientos psiquiátricos'].map(patologia => ({
            patologia,
            ...
            edad_presento: document.querySelector(`input[name="${patologia}_edad"]`)?.value || 'No hay información',
            secuela: document.querySelector(`input[name="${patologia}_secuelas"]`)?.value || 'No hay información',
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function saveFormData() {
        const formData = {};
        const inputs = document.querySelectorAll("#fichaForm input, #fichaForm select");
    ...
    function saveFormData1() {
        const formData1 = {};
        const inputs1 = document.querySelectorAll("#fichaForm1 input, #fichaForm1 textarea");
    ...
    function saveFormData6() {
        const formData6 = {};
        const inputs6 = document.querySelectorAll("#fichaForm6 input, #fichaForm6 textarea");
