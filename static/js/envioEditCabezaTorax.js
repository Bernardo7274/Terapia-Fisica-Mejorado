...
document.getElementById('miembroFormCabezaTorax').addEventListener('submit', function (event) {
    ...
    window.location.href = '/EdicionEvaluacionDeLaPostura'; // Redirige a la página de resumen
});
...
const establecerValor = (id, valor) => {
  ...
  if (id) {
    fetch('/consultarCabezaCuello', {
      ...
      .then(data => {
        ...
        establecerValor("observacionesCabezaCuello", data.observacionesCabezaCuello);
        establecerValor("palpacionCabezaCuello", data.palpacionCabezaCuello);
        establecerValor("dolorSuperiorCabezaCuello", data.dolorSuperiorCabezaCuello);
        establecerValor("dolorexplofisicaCabezaCuello", data.dolorexplofisicaCabezaCuello);
      })
      .catch(error => {
  ...
  if (id) {
    fetch('/consultarFuerzaMuscularCabezaTorax', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      .then(data => {
        ...
        // Actualizar los campos en el DOM con los datos obtenidos
        data.forEach(fuerza => {
          const { movimiento, valoresObtenidos } = fuerza;
  
          // Actualizar valores de los campos
          establecerValor(`${movimiento}_valoresObtenidos`, valoresObtenidos);
        });
      })
      .catch(error => {
        console.error("Error al consultar los datos:", error);
  ...
  if (id) {
    fetch('/consultarColumnaToraxAbdomen', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      .then(data => {
        ...
        // Actualizar los campos en el DOM con los datos obtenidos
        establecerValor("observacionesColumnaTóraxAbdomen", data.observacionesColumnaTóraxAbdomen);
        establecerValor("palpacionColumnaTóraxAbdomen", data.palpacionColumnaTóraxAbdomen);
        establecerValor("dolorSuperiorColumnaTóraxAbdomen", data.dolorSuperiorColumnaTóraxAbdomen);
        establecerValor("dolorexplofisicaColumnaTóraxAbdomen", data.dolorexplofisicaColumnaTóraxAbdomen);
      })
      .catch(error => {
        console.error("Error al consultar los datos:", error);
      });
  ...
  if (id) {
    fetch('/consultarFuerzaMuscularCabezaTorax2', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  if (id) {
    fetch('/consultarGoniometriaCabezaTorax', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      .then(data => {
        ...
        data.forEach(goniometria => {
          const { rango, movimiento, resultados } = goniometria;
  
          // Actualizar valores de los campos
          establecerValor(`${rango}_${movimiento}_resultados`, resultados);
        });
      })
      .catch(error => {
        console.error("Error al consultar los datos:", error);
  ...
  if (id) {
    fetch('/consultarPruebasEvaluacionesComplementariasCabezaTorax', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      .then(data => {
        ...
        data.forEach((prueba, index) => {
          ...
          establecerValor(`Pruebas_${index + 1}_CabezaTorax`, pruebaName);
          establecerValor(`Resultados y análisis_${index + 1}_CabezaTorax`, resultado);
        });
      })
      .catch(error => {
        console.error("Error al consultar los datos:", error);
